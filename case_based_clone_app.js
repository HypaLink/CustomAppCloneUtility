var options = {
    ...
    target_scope: "x_gur_change_this", // Should begin with x_gur_ to be consistent with GR's assigned scope id.
    ...
    target_module_name: "Appraisal Stuff", // This is the display name that appears in the menu navigation menu.
    target_task_table: "case", // The suffix portion of the primary task table's system name.  Should be Singular and should NOT include the target scope.  The generated name will automatically prepend the scope.  E.G. x_gur_origination_task
    target_task_table_name: "Appraisal Case", // The display name of the primary task table.  Should be Singular 
    target_number_prefix: "APR", // The numbering prefix for the primary task table.  

	/** name of update set file that should be used */
    source_update_set_file: 'GR CSM Template.xml',




    /** DO NOT UPDATE - this is the scope assigned by ServiceNow to GuaranteedRate.*/
    company_scope: "x_gur",

    /** DO NOT UPDATE these settings, unless the template itself changes */
    source_scope: "x_gur_grt_csm",
    source_app_name: "GR CSM Template",
    source_module_name: "GR CSM Template Module",
    source_task_table: "case",
    source_task_table_name: "GR CSM Case",
    source_number_prefix: "GRC",
}
...
function getDefinedGuids(text) {
	...
	//    or...
	// &lt;sys_id&gt;218a31621bdc78101abb0d47dc4bcb1f&lt;/sys_id&gt;
